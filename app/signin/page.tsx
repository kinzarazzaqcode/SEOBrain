    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-20 xl:px-24">
        ...
        >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-11 pr-11 h-12 bg-slate-50 border-slate-200 focus:bg-white"
                />
                <button
                  type="button"
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="h-12 bg-white hover:bg-slate-50">
      ...
      <div className="hidden lg:flex lg:flex-1 relative overflow-hidden bg-gradient-to-br from-violet-600 via-purple-600 to-blue-600">
        ...
        <motion.div
          ...
          className="absolute top-1/2 right-1/3 w-48 h-48 bg-purple-300/20 rounded-full blur-3xl"
        />
        ...
        <div className="relative z-10 flex items-center justify-center w-full p-12">
          <div className="text-center text-white max-w-md">
            ...
            >
              <h2 className="text-3xl font-bold mb-4">Grow your online presence</h2>
              <p className="text-white/80 text-lg leading-relaxed">
                Join 50,000+ marketers using SeoBrain to automate their SEO workflows and discover new opportunities.
              </p>
            </motion.div>
          </div>
        </div>
